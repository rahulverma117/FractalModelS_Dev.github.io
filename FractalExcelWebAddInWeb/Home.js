(function () {
    ...
    Office.initialize = function (reason) {
        $(document).ready(function () {
            ...
            $("#simulateProjectLife").click(calcProjectLife);
    ...
    for (i = 0; i < numTimestamps; i++) {
        ...
        if (battEnabled) {
            ...
            if (ac) {
                ...
                var vSiteOutput_l2 = vWindAC_l2 + vSolarAC_l2 + vACCoupledBattNetThr_l2;
                if (vSiteOutput_l2 > 0) {
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                ...
                                case 1:
                                    ...
                                    var projectLife = 15 //Math.max(solarLife, windLife, battLife);
                                    var maxModelLife = 40;
